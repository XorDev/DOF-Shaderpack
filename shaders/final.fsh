...
vec2 hash(vec2 p)
{
	return normalize(fract(cos(p*mat2(94.55,-69.38,-89.27,78.69))*825.79)-.5);
}
...
void main()
{
    float radius = texture2D(texture,coord0).a*Size*.5;
    ...
    gl_FragData[0] = color * unpack_color(col / weight);
}
